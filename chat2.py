...
Chatter = namedtuple('Chatter','user_name ip_address')
userSet = set()
...
def receive(my_user_name, port=12000):
  ...
  while isRunning:
    ...
    if (command=='TALK'):
      ...
      if [user_name, src_ip] in userSet:
        userSet.remove([user_name, src_ip])
    else:
